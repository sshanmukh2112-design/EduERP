        ...
        <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12">
            <form onSubmit={handleSubmit} className="w-full max-w-sm bg-black border border-[#222] p-8">
                ...
                <div className="mt-6 text-center space-y-4">
                    <div>
                        <span className="font-mono text-xs text-[#555]">Already have an account? </span>
                        <Link to={`/login/${role}`} className="font-mono text-xs text-accent hover:text-white transition-colors">
                            Sign In
                        </Link>
                    </div>
